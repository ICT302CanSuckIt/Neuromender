...
function ValidateArmMaxExtension( threshold, output )
{
	...
	{
		//output.string += "Please enter valid angled threshold\n";
		document.getElementById("ArmMaxExtensionError").textContent = "Please enter valid angle threshold";
		return false;
	}
	else
	{
...
function ValidateGraphicLow( speed, output )
{
	...
	{
		document.getElementById("GraphicLowError").textContent = "";
		return true;
	}
}
...
function ValidateGraphicMedium( speed, output )
{
	...
	{
		document.getElementById("GraphicMediumError").textContent = "";
		return true;
	}
}
...
function ValidateGraphicHigh( speed, output )
{
	...
	{
		document.getElementById("GraphicHighError").textContent = "";
		return true;
	}
}
