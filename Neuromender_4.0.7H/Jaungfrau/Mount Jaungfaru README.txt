...
If you should want to export this again for any reason:
  http://terrain.party/api/export?name=Mount+Jaungfaru&box=8.099520,46.614029,7.864123,46.452333
...
-----------
  ...
  * Mount Jaungfaru Height Map (ASTER 30m).png
  ...
  * Mount Jaungfaru Height Map (Merged).png
...
[!] If you look at one height map, look at this one. [!]
  ...
  * Mount Jaungfaru Height Map (SRTM3 v4.1).png
  ...
  * Mount Jaungfaru Height Map (SRTM30 Plus).png
...
These heightmaps were adjusted such that 714m (actual) is equal to 40m in
