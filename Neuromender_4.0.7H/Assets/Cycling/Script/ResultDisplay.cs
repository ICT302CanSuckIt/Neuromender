...
public class ResultDisplay : MonoBehaviour {
    ...
    void Update()
    {
        ...
        if (Input.GetKeyDown("space")) // Temporary solution need to implement proper quit button
        {
    ...
    public void DisplayEndPanel()
    {
        ...
        userConfig.gamesPlayed.CyclingPlayed = true;
        Distance = startpoint.GetComponent<StartingPoint>().route;
