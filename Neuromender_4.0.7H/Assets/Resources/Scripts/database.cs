...
public class database : MonoBehaviour {
    ...
    //private string connStr = "server=vegas.murdoch.edu.au;user=neuroadmin4;database=Neuromender4;port=3306;password=*7BA7FB152973F6C4434A6BC54E94A7366969EDFE;";   THIS WAS THE OLD ONE - 13/9/2017

	//made connection to an external file
	private string connStr;
	public TextAsset blah;
	...
	void Start () {
		...
		//find server info from external file
		connStr = blah.text;
